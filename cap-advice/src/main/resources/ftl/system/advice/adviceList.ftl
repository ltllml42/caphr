        ...
        if (type == '1') {
            ...
            table.render({
                ...
                , cols: [[
                    {checkbox: true, fixed: true, width: '5%'}
                    , {field: 'type', title: '类型', width: '15%', templet: '#typeTemp', sort: true}
                    , {field: 'name', title: '上报人姓名', width: '20%', sort: true}
                    , {field: 'title', title: '标题', width: '20%', sort: true}
                    , {field: 'status', title: '状态', width: '10%', templet: '#statusTemp', sort: true}
                    , {field: 'createDate', title: '提交时间', width: '20%',templet: '<div>{{ layui.laytpl.toDateString(d.createDate,"yyyy-MM-dd") }}</div>',sort: true}
