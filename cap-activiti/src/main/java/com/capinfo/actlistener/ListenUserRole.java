...
public class ListenUserRole {
     ...
     * @param joinPoint
     */
    @Around("execution(com.capinfo.util.JsonUtil com.capinfo.controller.UserController.updateUser(*,String[]))")
     ...
     * @param joinPoint
     */
    @Around("execution(com.capinfo.util.JsonUtil com.capinfo.controller.UserController.addUser(*,String[]))")
    ...
    @Around("execution(com.capinfo.util.JsonUtil com.capinfo.controller.UserController.del(..))")
    ...
    /**********************角色处理begin***************************/
    @Around("execution(com.capinfo.util.JsonUtil com.capinfo.controller.RoleController.addRole(*,String[]))")
    ...
    @Around("execution(com.capinfo.util.JsonUtil com.capinfo.controller.RoleController.updateUser(*,String[]))")
    ...
    @Around("execution(com.capinfo.util.JsonUtil com.capinfo.controller.RoleController.del(..))")
